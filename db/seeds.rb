...
#   Mayor.create(name: 'Emanuel', city: cities.first)
  ...
  user = User.create!(first_name:"Matt", last_name:"Fair", email:"matt@aol.com", password:"password", password_confirmation:"password",email_optout:true, address_1:Faker::Address.street_address, city:Faker::Address.city, state:Faker::Address.state_abbr, zip:Faker::Address.zip, phone1:Faker::PhoneNumber.cell_phone)
  ...
  team1 = Team.create!(name:"The #{Faker::Hacker.noun.pluralize}", user_id:user.id)
  team1.update!(original_id:team1.id)
  5.times do
    new_user3 = User.create!(first_name:Faker::Name.first_name, last_name:Faker::Name.last_name, email:Faker::Internet.email, password:"password",email_optout:true, password_confirmation:"password", address_1:Faker::Address.street_address, city:Faker::Address.city, state:Faker::Address.state_abbr, zip:Faker::Address.zip, phone1:Faker::PhoneNumber.cell_phone)
    team1.players << player = Player.create(first_name:Faker::Name.first_name, last_name:Faker::Name.last_name,user_id:new_user3.id, date_of_birth:Faker::Date.between(10.years.ago, 8.years.ago), jersey_number:Faker::Number.between(0, 99))
  end
  10.times do
